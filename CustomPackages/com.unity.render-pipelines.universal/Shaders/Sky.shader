...
Shader "Universal Render Pipeline/Sky"
{
Properties 
{
    [KeywordEnum(None, Simple, High Quality)] _SunDisk ("Sun", Int) = 2
    _SunSize ("Sun Size", Range(0,1)) = 0.04
    _SunBrightness ("Sun Brightness", Range(0,120000)) = 800
    _SunSizeConvergence("Sun Size Convergence", Range(1,1000)) = 5
    _SunConvergenceBias("Sun Convergence Bias", Range(0,0.01)) = 0
...
SubShader
{
    ...
    Pass
    {
        ...
        uniform half _SunConvergenceBias;
        ...
        //static const half kHDSundiskIntensityFactor = 800.0;
        //static const half kSimpleSundiskIntensityFactor = 6000.0;
...
//              for(int i=0; i<int(kSamples); i++) // Loop removed because we kept hitting SM2.0 temp variable limits. Doesn't affect the image too much.
            ...
            half lightColorIntensity = clamp(length(_LightColor0.xyz), 0.25, 1);
                ...
                OUT.sunColor    = _SunBrightness * saturate(cOut * kSunScale) * _LightColor0.xyz / lightColorIntensity;
            #else // SKYBOX_SUNDISK_HQ
                OUT.sunColor    = _SunBrightness * saturate(cOut) * _LightColor0.xyz / lightColorIntensity;
            #endif
